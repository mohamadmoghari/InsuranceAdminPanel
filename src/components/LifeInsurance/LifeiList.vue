    ...
    <section class="table-responsive">
      <table class="table table-stripped mb-0">
        ...
        <tr v-for="singleInsurance in insuranceLists" :key="singleInsurance.id">
          ...
          <td>{{ singleInsurance.q1 }}</td>
          <td>{{ singleInsurance.q2 }}</td>
          <td>{{ singleInsurance.q3 }}</td>
          <td>{{ singleInsurance.q4 }}</td>
          <td>{{ singleInsurance.q5 }}</td>
          <td>{{ singleInsurance.q6 }}</td>
          <td>{{ singleInsurance.q7 }}</td>
          <td>{{ singleInsurance.q8 }}</td>
...
export default {
  ...
  methods: {
    getAllInsuranceList() {
      this.loading = true
      this.$store.dispatch('LifeInsurance/getAllCarInsuranceList', this.filter)
        .then(response => {
    ...
    removeSingleInsurance() {
      ...
      this.$store.dispatch('LifeInsurance/deleteSingleCarInsurance', this.removeSingleInsuranceId)
        .then(response => {
